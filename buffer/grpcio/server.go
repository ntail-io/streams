...
func NewServer(ctx context.Context, addr string, service *BufferService, useAlts bool) error {
	...
	log.Infof("Listening for grpc on %s\n", addr)
	...
	group.Go(func() error {
		...
		v1.RegisterBufferServiceServer(s, service)
